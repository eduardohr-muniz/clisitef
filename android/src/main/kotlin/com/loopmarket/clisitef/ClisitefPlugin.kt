...
class ClisitefPlugin: FlutterPlugin, MethodCallHandler {
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    ...
    when (call.method) {
      ...
      "configure" -> tefMethods.configure(call.argument<String>("enderecoSitef")!!, call.argument<String>("codigoLoja")!!, call.argument<String>("numeroTerminal")!!, "[TipoPinPad="+call.argument<String>("tipoPinPad")!!+"];[ParmsClient=1="+call.argument<String>("cnpjLoja")!!+";2="+call.argument<String>("cnpjEmpresa")!!+"]")
