...
class ClisitefPlugin: FlutterPlugin, MethodCallHandler, ActivityAware {
  ...
  override fun onMethodCall(@NonNull call: MethodCall, @NonNull result: Result) {
    ...
    when (call.method) {
      ...
      // "configure" -> tefMethods.configure(call.argument<String>("enderecoSitef")!!, call.argument<String>("codigoLoja")!!, call.argument<String>("numeroTerminal")!!, "[TipoPinPad="+call.argument<String>("tipoPinPad")!!+"];[ParmsClient=1="+call.argument<String>("cnpjLoja")!!+";2="+call.argument<String>("cnpjAutomacao")!!+";"+call.argument<String>("parametrosAdicionais")!!+";[TipoComunicacaoExterna=TLSGWP;TokenRegistro=1111-2222-3333-4444]]")
      "configure" -> tefMethods.configure(call.argument<String>("enderecoSitef")!!, call.argument<String>("codigoLoja")!!, call.argument<String>("numeroTerminal")!!, "[TipoPinPad="+call.argument<String>("tipoPinPad")!!+"];[ParmsClient=1="+call.argument<String>("cnpjLoja")!!+";2="+call.argument<String>("cnpjAutomacao")!!+";"+call.argument<String>("parametrosAdicionais")!!+";[TipoComunicacaoExterna="+call.argument<String>("tipoComunicacao")!!+";TokenRegistro="+call.argument<String>("tokenRegistro")!!+"]]")
